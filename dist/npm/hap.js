...
module.exports = {
    ...
    isObject: function isObject(ob, real) {
        if (real) {
            ...
            return ob && (typeof ob === 'undefined' ? 'undefined' : (0, _typeof3.default)(ob)) === 'object';
        }
    },
...
function EngineWrapper(adapter) {
    var AjaxEngine = function () {
        function AjaxEngine() {
            (0, _classCallCheck3.default)(this, AjaxEngine);
        ...
        (0, _createClass3.default)(AjaxEngine, [{
            key: "_call",
    ...
    function Fly(engine) {
        ...
        function wrap(interceptor) {
            ...
            utils.merge(interceptor, {
                lock: function lock() {
                    if (!resolve) {
                        interceptor.p = new _promise2.default(function (_resolve, _reject) {
                            resolve = _resolve;
                            reject = _reject;
                        });
                    }
        ...
        value: function request(url, data, options) {
            ...
            var promise = new _promise2.default(function (resolve, reject) {
                    ...
                    function onresult(handler, data, type) {
                        enqueueIfLocked(responseInterceptor.p, function () {
                            if (handler) {
                                ...
                                var ret = handler.call(responseInterceptor, data, _promise2.default);
                                data = ret === undefined ? data : ret;
                            }
                            if (!isPromise(data)) {
                                data = _promise2.default[type === 0 ? "resolve" : "reject"](data);
                            }
                ...
                enqueueIfLocked(requestInterceptor.p, function () {
                    utils.merge(options, JSON.parse((0, _stringify2.default)(_this.config)));
                    ...
                    if (requestInterceptorHandler) {
                        ret = requestInterceptorHandler.call(requestInterceptor, options, _promise2.default) || options;
                    }
                    if (!isPromise(ret)) {
                        ret = _promise2.default.resolve(ret);
                    }
                    ret.then(function (d) {
                        //if options continue
                        if (d === options) {
...
var adapter = __webpack_require__(100);
module.exports = function (fetch) {
